...
WiFi Setup</button></form><form action="/settings/sync"><button type="submit">
Sync Interfaces</button></form></body></html>)=====";
...
Back</button><button type="submit">Save & Connect</button><hr><h2>
WiFi einrichten</h2><h3>Mit lokalem Netzwerk verbinden</h3>Routername (SSID):
<br><input name="CS" maxlength="32"><br>Netzwerkschlüssel:<br><input 
type="password" name="CP" maxlength="63"><br>
